...
## 1️⃣ SCHEINWERFER — Facelift vs. Vorfacelift Upgrade

### Ausgangslage
- V50 2.4i Pre-Facelift (2004-2007): Chrom-Einfassung Scheinwerfer, gelbe/vergilbte Streuscheiben
- V50 Facelift (2008-2012): Schwarz eingefasste Scheinwerfer, klarere Optik, modernerer Look
- ✅ LED Fern+Abblend bereits verbaut (laut README)

### Facelift Scheinwerfer — die STEALTH-Option

| Attribut | Pre-Facelift (2004-2007) | Facelift (2008-2012) |
|----------|--------------------------|----------------------|
| Optik | Chrom-Einfassung, leicht gelb | Schwarz/Chrom, klarer, moderner |
| Streuscheibe | Tendenz zur Vergilbung | Klarerglas, bessere Ausleuchtung |
| Beleuchtung | Gleiche H7-Birne | Gleiche H7-Birne |
| Stecker | Gleich | Gleich (Plug&Play!) |
| Passform | — | ✅ Passt an Pre-FL Karosserie! |
...
| Position | OEM Teilenummer | Beschreibung | HINWEIS |
|----------|-----------------|-------------|---------|
| Facelift H7 links (LHD) | **31265914** | H7 Halogen, links | ✅ DAS brauchen wir |
| Facelift H7 rechts (LHD) | **31265915** | H7 Halogen, rechts | ✅ DAS brauchen wir |
| Facelift Xenon links | 31265916 | Xenon, links | ❌ NICHT kaufen! |
| Facelift Xenon rechts | 31265917 | Xenon, rechts | ❌ NICHT kaufen! |
| Facelift Xenon Bi-Xenon links | 31265698 | Bi-Xenon ABL links | ❌ NICHT kaufen! |
| Facelift Xenon Bi-Xenon rechts | 31265699 | Bi-Xenon ABL rechts | ❌ NICHT kaufen! |
| Pre-FL H7 links | 30796020 | Alte Nummer | Das ist was wir ERSETZEN |
| Pre-FL H7 rechts | 30796021 | Alte Nummer | Das ist was wir ERSETZEN |
...
- **Elektrik**: 8-poliger H7 Stecker identisch Pre-FL → FL (Halogen). Direkt stecken.
- **Mechanisch**: Gleiche 4-Schraub-Montage am V50 Frontend. Direct bolt-in.
- **Grill-Kompatibilität**: Facelift-SW haben etwas andere Profilkante innen. Mit Pre-FL Grill: ~5-8mm Lücke. Lösung: FL-Grill mitkaufen (31330657/31330658).
- **Stoßfänger**: Passt ohne Modifikation.
- **CAN-Bus**: Keine Probleme bei H7 Halogen. Keine Software/VIDA nötig.
...
## 2️⃣ RÜCKLICHTER — LED in OEM-Qualität

### Ausgangslage
- V50 Pre-Facelift: Glühlampen-Rücklichter (Standard)
- V50 Facelift (ab 2008): **Immer noch Glühlampen!** Volvo hat NIE LED-Rücklichter im V50 verbaut
- Aftermarket LED-Rücklichter: Verfügbar, aber QUALITÄT ist das Problem

### Aftermarket LED-Rücklichter — die Realität

| Attribut | Bewertung |
|----------|-----------|
| Optik | ⚠️ Mixen — manche sehen OEM aus, manche billiger als ein Dacia |
| Lichtverteilung | ⚠️ Oft ungleichmäßig, LED-Reihen sichtbar = Alibaba-Look |
...
**Option B: Facelift-Glühlampen-Rücklichter (OEM)**
- Kosten: €50-100/Paar gebraucht
- Kein TÜV-Aufwand
- STEALTH-Faktor: 🟢🟢 MAXIMAL — 100% OEM, fällt nicht auf
- Upgrade: Heller Glühlampen (Osram Night Breaker) = fast LED-Helligkeit

**Option C: Orig. Rücklichter reinigen + neu versiegeln**
- Kosten: €20-40 DIY
- 100% legal, 100% OEM-Look
- STEALTH-Faktor: 🟢🟢🟢 — wie neu

**🏆 STEALTH-EMPFEHLUNG**: **Option B** — Facelift-Rücklichter gebraucht (oder Option C: Originale aufbereiten). LED-Rücklichter bei V50 = Alibaba-Look-Risiko. Wer DENKT, er braucht LED: TYC oder In.Pro MIT EG-Gutachten. Nichts anderes.

---

## 3️⃣ GRILL — Schwarz vs. Chrom OEM

### Ausgangslage
- V50 Pre-Facelift: Chrom-Grill (Standard)
- V50 R-Design/Facelift: Schwarz-Grill (Option)
- Aftermarket: Verschiedene schwarze Grills
...
|-------------|-------------|-------|
| **30798393** | Ecklicht links Facelift | €12-20 |
...
## 4️⃣ POLIERUNG + LACKSCHUTZ

### Polierung — Grundlage für alles

| Art | DIY Material | Professionell | Ergebnis | Haltbarkeit |
|-----|-------------|---------------|----------|-------------|
| Einsteiger-Politur | €20-40 | €150-300 | Kratzer raus, mäßiger Glanz | 3-6 Monate |
| Zweistufige Politur | €40-70 | €250-400 | Tiefenglanz, wie neu | 3-6 Monate |
| Dreistufige Politur | €60-90 | €400-600 | Showroom-Qualität | 3-6 Monate (ohne Schutz) |

> **Polierung ohne Schutz = Geldverschwendung!** Nach 3-6 Monaten ist der Glanz wieder weg. IMMER Schutz danach!
...
2. Keramik-Spray (6-Monate) — €15-25
3. → Ergebnis: Sauber, aber nicht "wie neu"

---

## 5️⃣ KOTFLÜGEL/SCHWELLER — Rost-Reparatur

### V50 Rost-Problemstellen
...
| Radlauf-Innenseite | 🔴 HÄUFIG | 🔴 Schwer | €150-350 pro Seite |

### Rost-Reparatur Optionen
...
- **VOR Polierung und Lackschutz machen!** Rost weg = Basis für alles andere
- **Beste Option**: Neue Aftermarket-Kotflügel (€50-80/Stück) + teillackiert (€150-250) = €200-330 pro Seite
- **STRICT STEALTH**: Nur OEM-Kotflügel oder Aftermarket mit perfekter Passform
- **Wichtig**: Blendlackierung machen lassen (Farbübergang = unsichtbar)

---

## 6️⃣ HECK — Diffusor-Insert

### Ausgangslage
- V50 Standard: Schwarzer Kunststoff-Diffusor (einfach)
- V50 R-Design: Dunkler/schwarzer Diffusor mit feinerem Design
- Aftermarket: Kaum verfügbar für V50 (kein Markt!)
- Heico Sportiv: Diffusor-Einsatz, aber teuer (€400+)
...
## 7️⃣ SPIEGELKAPPE — Schwarz statt Chrom

### Ausgangslage
- V50 Pre-Facelift: Chrom-Spiegelkappen (Standard bei höheren Ausstattungen)
- V50 Facelift/R-Design: Schwarz-Spiegelkappen
- V50 Basis: Bereits schwarz (bodycolor oder schwarz)
...
## 8️⃣ PREISE — KOMPLETTÜBERSICHT (aktualisiert Mai 2026)

### Phase 3 Optik — Preis-Tabelle
...
>
> **EMPFEHLUNG**: Kotflügel Priorität über PPF. Rost stoppen > Steinschlag-Schutz.

### Priorität-Reihenfolge (wichtig zuerst)

1. **🔴 Rost-Reparatur** (wenn Rost vorhanden) — Fundament für alles andere
2. **🔴 Polierung** — Basis für den "wie neu"-Look
3. **🔴 Keramikversiegelung** — Schutz der Polierung
4. **🔴 Facelift-Scheinwerfer + Ecklichter** — Größter optischer Unterschied
5. **🟡 Grill schwarz OEM** — 2.-größter Unterschied, günstig
6. **🟡 Spiegelkappen** — Chrom→Schwarz = saubererer Look
7. **🟡 Diffusor schwarz** — Kleine Sache, großer Effekt
8. **🟢 PPF Front** — Nice-to-have wenn Budget reicht
9. **🟢 LED-Rücklichter** — Nice-to-have, RISIKO (Qualität!)

---

## ⚠️ WARNUNGEN & PITFALLS
...
- ❌ PPF selbst kleben (ohne Erfahrung) = Blasen = schlimmer als kein PPF
- ❌ Xenon-Scheinwerfer kaufen! Brauchen Niveauregulierung + Waschanlage = TÜV-Fiasko
- ❌ RHD (Rechtslenker) Scheinwerfer aus UK = falsche Lichtverteilung!

### ✅ DO make!
- ✅ Facelift-Scheinwerfer H7 = bester Stealth-Upgrade überhaupt
- ✅ FL-Ecklichter MITKAUFEN = keine Lücken
- ✅ OEM-Schwarzgrill = unsichtbar sportlich
...
## 📋 EINKAUFS-LISTE (Prioritäts-Reihenfolge)
...
```
1. Rost-Reparatur (wenn nötig) — MUSS ZUERST!
   ↓
2. Lackierer (Kotflügel + Spiegelkappen + Blendlackierung)
   ↓
3. Polierung (auf NEUEN Lack = perfektes Ergebnis)
   ↓
4. Keramikversiegelung (direkt nach Polierung)
   ↓
5. PPF (optional, wenn Budget reicht)
   ↓
6. Scheinwerfer + Ecklichter wechseln (30 min, DIY)
   ↓
7. Grill wechseln (10 min, DIY)
   ↓
8. Diffusor folieren (1h, DIY)
```

> **WICHTIG**: Polierung ERST nach Rost-Reparatur und Lackierer! Sonst polierst du Rost.
