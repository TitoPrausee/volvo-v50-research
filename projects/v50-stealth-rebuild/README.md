# 🚗 Volvo V50 2.4i Stealth Rebuild

## Vision
**V50 Kombi — sieht aus wie neu, fährt sich sportlich, 100% legal, fällt nicht auf.**

- Basis: Volvo V50 2.4i (B5244S, 5-Zylinder, 103kW/140PS)
- Felgen: 17" BEHALTEN — keine Änderung
- Reifen: BEHALTEN — keine Änderung
- LED: Fernlicht + Abblendlicht schon verbaut ✅
- Ziel: Wie ein **Neuwagen-Build** — alles neu, alles clean, alles dezent
- Sportlich aber **unauffällig** — kein Show-Off, kein Ricer, kein illegales
- 100% TÜV-konform — jede Änderung legal oder eintragbar

## Was "Stealth Rebuild" bedeutet
- Austausch alter/gelber/verschwissener Teile gegen NEUE oder HOCHWERTIGE Teile
- Sportliche Verbesserung die man **fühlt, nicht sieht**
...
|-------|-------|--------|-----------|
| 1 | Sicherheit + Zuverlässigkeit (Bremsen, Zahnriemen, Öl) | €500-800 | 🔴 Kritisch |
| 2 | Fahrwerk sportlich-dezent (Federn, Dämpfer, Stabis) | €800-1.200 | 🔴 Kritisch |
| 3 | Optik neu & clean (Lack, Scheinwerfer, Rücklichter, Grill) | €800-1.200 | 🟡 Wichtig |
| 4 | Motor sanft (Intake, Auspuff E-nummerig) | €400-600 | 🟢 Nice-to-have |
...
- ❌ Keine 18" oder 19" Felgen — 17" bleiben
- ❌ Keine breiteren Reifen — OEM-Größe bleibt
- ❌ Kein Tieferlegung unter -30mm (auffällig + TÜV-Probleme)
- ❌ Kein lauter Auspuff ohne E-Nummer
- ❌ Keine getönten Scheiben (außer OEM hinten)
- ❌ Kein Spoiler, keine Schürzen, keine Aufkleber
...
- ✅ Kat-Back Auspuff E-nummerig (Ferrita F-V50-01)
- ✅ Polierung + Keramikversiegelung (wie neu aussehend)
- ✅ Spiegelkappen schwarz (folieren oder lackieren)
